...
/**
 * This class encapsulates all constants that are related to the database
 */
...
final class DBConstants {
    ...
    static final String taskAccomplishedKey = "accomplished";
    static final String taskAssigneeKey = "assignee";
